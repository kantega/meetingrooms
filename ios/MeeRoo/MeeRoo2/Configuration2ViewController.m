//
//  Configuration2ViewController.m
//  MeeRoo2
//
...
@implementation Configuration2ViewController
...
-(void)loadView
{
    ...
    UIView *customView = [[UIView alloc]initWithFrame:[[UIScreen mainScreen]applicationFrame]] ; //equals CGRectMake(0,0,1024,768)
    customView.backgroundColor = [UIColor darkGrayColor];
    customView.autoresizesSubviews = NO;
    customView.clipsToBounds = NO;
    
    self.velgmoteLabel = [[[UILabel alloc]initWithFrame:CGRectMake((1024-250)/2, 20, 250, 36)] autorelease];
    ...
    self.roomPickerView = [[[UIPickerView alloc]initWithFrame:CGRectMake(50, 150, 450, 216)] autorelease];
    ...
    self.trondheimPickerView = [[[UIPickerView alloc]initWithFrame:CGRectMake(550, 150, 400, 216)] autorelease];    
...
- (void)viewDidLoad
{
    ...
    self.oslorooms = [[[NSMutableArray alloc]init] autorelease];
    self.trondheimrooms = [[[NSMutableArray alloc]init] autorelease];
    
    self.oslo = [[[NSMutableArray alloc]init] autorelease];
    self.trondheim = [[[NSMutableArray alloc]init] autorelease];
    ...
    for( NSInteger i = 0; i < self.meetingrooms.count; i++){
        ...
        //10 des 12
        //via dot methods
        NSString* line = ((MeetingRoom2*)[self.meetingrooms objectAtIndex:i]).getLocation;
