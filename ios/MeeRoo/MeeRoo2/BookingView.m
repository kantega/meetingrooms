...
-(id)init{
    ...
    [self initWithFrame:CGRectMake(0,0,500,560)];
    return self;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //9 jan 13
        //16 jan 13: Bruker knapper i stedet
        //PICKERVIEW
        self.scroller = [[[UIPickerView alloc] initWithFrame:CGRectMake((500-445)/2,180,445,216)] autorelease];
